// ============================================================================
// Product list comes from Supabase (list_key='b15-stock-take').
// Cached in localStorage; re-fetched only when user clicks the title (no scan records in progress).
// ============================================================================

const PRODUCT_LIST_KEY = 'b15-stock-take';
const STORAGE_PRODUCTS = 'masterProductList_b15';
...
const PRODUCTS_FALLBACK = [
  ...
  },
  {
    ...
    skus: [
      { type: "CTN", name: "芝士皇帝蟹味丸 CHEESE FLAVOURED KING CRAB BALL", packaging: "250g x 20pkt", itemCode: "26116" }
    ],
    scanned: false
  },
     {
    ...
    skus: [
      { type: "CTN", name: "过年鱼饺 FISH DUMPLING", packaging: "20's x 20tray", itemCode: "10100" }
    ],
    scanned: false
  },
     {
    ...
    skus: [
      { type: "CTN", name: "鱼饺 FISH DUMPLING", packaging: "10's x 60tray", itemCode: "10110.1" }
    ],
    scanned: false
  },
     {
    ...
    packaging: "10's x 60tray",
    skus: [
      { type: "CTN", name: "结冰鱼饺 FISH DUMPLING", packaging: "10's x 60tray", itemCode: "10110.2" }
    ],
    scanned: false
  },
  {
